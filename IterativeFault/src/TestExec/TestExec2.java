	...
	public static void mainProcessDir(){
		...
		try{
			...
			while((eachInput=inputBR.readLine())!=null){
				...
				origTraceBW.write("*****" + numRun + "#" + numRun + "\n");
				origTraceBW.close();
				...
				seededTraceBW.write("*****" + numRun +  "#" + numRun + "\n");
				seededTraceBW.close();
			}
		}
		catch(IOException e){
